...
<table>
    ...
    <tr>
        ...
        <td>
            Aprenentatge basat en simulació de cas real.<br>
            Aprenentatge basat en investigació.<br>
            Classe magistral participativa.<br>
            Treball en equip.
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <li>Organització dels equips. Tria de projecte entre les opcions proposades o proposar un de nou.</li>
        ...
        <td rowspan="5">
            Observacions del gestor d'equips (professorat) durant les reunions (20%), avaluades amb rúbrica.
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <li>Explicació de procediments d'extracció i integració de dades (ETL/ELT). Revisió de tecnologies. </li>
            <li>Revisió i discussió oberta de bones pràctiques en els procediments d'extracció i integració de dades. Aspectes de l'enginyeria de dades i la gestió de dades (Data Management). </li>
            <li>Treball en equip: proposta de tecnologies i procediments a emprar en l'extracció i integració de dades. </li>
        </td>
        <td>
            Apunts de les discussions obertes. Actualització de la documentació, afegint-hi un esquema del fluxe de dades i els passos d'extracció i integració.
        </td>
    </tr>
    <tr>
        <td>
            ...
            <li>Treball en equip: (1) disseny del model lògic al DWH, (2) disseny de fins a 5 mètriques rellevants. </li>
            <li>Tercera reunió amb el gestor d'equip per revisar la proposta de l'arquitectura del DWH.</li>
        </td>
        <td>
            Apunts de les discussions obertes i de la reunió. Actualització de la documentació, afegint-hi un esquema del disseny del model lògic i les propostes de mètriques.
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td rowspan="1">
            Documentació del projecte (50%) avaluada amb rúbrica.<br>
            Presentació del projecte (30%) avaluada amb rúbrica (incloent coavaluació).
        </td>
    </tr>
</table>
